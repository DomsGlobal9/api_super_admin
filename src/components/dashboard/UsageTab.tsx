...
export function UsageTab() {
  ...
  if (loading) return <div className="space-y-4 animate-pulse mt-6"><div className="h-10 bg-gray-200 dark:bg-gray-800 rounded w-1/4"></div><div className="grid grid-cols-4 gap-4"><div className="h-24 bg-gray-200 dark:bg-gray-800 rounded"></div><div className="h-24 bg-gray-200 dark:bg-gray-800 rounded"></div><div className="h-24 bg-gray-200 dark:bg-gray-800 rounded"></div><div className="h-24 bg-gray-200 dark:bg-gray-800 rounded"></div></div></div>;
  if (error) return <div className="p-4 bg-red-50 text-red-500 rounded-md mt-6">Error: {error}</div>;
  if (!data) return <div className="mt-6">No usage metrics found.</div>;
